...
<div id="userDropdown" class="hidden fixed w-72 bg-white rounded-2xl shadow-2xl border border-gray-100 overflow-hidden" style="z-index: 99999; top: 70px; right: 24px;">
    ...
    <div class="p-3 space-y-1">
        <a href="/PHP-BCTH/public/student/profile" class="flex items-center gap-3 px-4 py-3 text-gray-700 hover:bg-gray-50 rounded-xl transition-all">
            <i class="bi bi-person text-gray-500"></i>
            <span>Thông tin cá nhân</span>
        </a>
        <a href="/PHP-BCTH/public/student/changePassword" class="flex items-center gap-3 px-4 py-3 text-gray-700 hover:bg-gray-50 rounded-xl transition-all">
            <i class="bi bi-lock text-gray-500"></i>
            <span>Đổi mật khẩu</span>
        </a>
        <div class="border-t border-gray-100 mt-2 pt-2">
            <a href="/PHP-BCTH/public/logout" class="flex items-center gap-3 px-4 py-3 text-red-500 hover:bg-red-50 rounded-xl transition-all">
